...
- Responsibility: user CLI tools, dev environments, user services, orchestrator of jobs (maintenance, sync etc) and manage symlinks.
...
- Responsibility: dotfiles (configs), Plasma layout.
